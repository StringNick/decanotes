 ...
 */
const DividerComponent = memo(
  forwardRef<FocusableHandle, BlockComponentProps>(
    ({ block, onUpdate, onFocus, onBlur, isSelected, isEditing, style }, ref) => {
      ...
      return (
        <View style={[styles.container, getSpacingStyle(), style]}>
          ...
          {isStyleEditing && (
            <View style={styles.styleSelector}>
              ...
              {Object.entries(DIVIDER_STYLES).map(([styleKey, styleConfig]) => (
                <TouchableOpacity
                  key={styleKey}
                  style={[styles.styleOption, dividerStyle === styleKey && styles.selectedStyle]}
              ...
              <View style={styles.controlGroup}>
                ...
                <View style={styles.thicknessControls}>
                  {[1, 2, 3, 4, 5].map(t => (
                    <TouchableOpacity
                      key={t}
                      style={[styles.thicknessOption, thickness === t && styles.selectedThickness]}
          ...
          {/* Divider */}
          <TouchableOpacity
            style={[styles.dividerContainer, isSelected && styles.selected, isEditing && styles.editing]}
